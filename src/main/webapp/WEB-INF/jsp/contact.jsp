                ...
                <div class="row">
                    <div class="icon-entry col-sm-4 wow fadeInLeft animated" data-wow-delay="0.3s"
                        ...
                        <div class="content">
                            ...
                            <div class="text">REMOVED  <br> REMOVED <br> NAVER</div>
                        </div>
                    </div>
                    <div class="icon-entry col-sm-4 wow fadeInUp animated" data-wow-delay="0.4s"
                        ...
                        <div class="content">
                            ...
                            <div class="text"><b>사무실:</b> REMOVED <br> <b>Mobile:</b> REMOVED
                            </div>
                        </div>
                    </div>
                    <div class="icon-entry col-sm-4 wow fadeInRight animated" data-wow-delay="0.3s"
                        ...
                        <div class="content">
                            ...
                            <div class="text"><b>회사메일:</b> leebokeum87@gmail.com <br> <b>Gmail:</b> leebokeum87@gmail.com
