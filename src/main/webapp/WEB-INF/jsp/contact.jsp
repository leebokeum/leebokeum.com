                ...
                <div class="container">
                    ...
                    <!-- <div class="row wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;"> -->
                        <div class="block-header col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0">
                            <h2 class="title">연락 정보</h2>
                            <div class="text">저에게 연락하시려면 아래를 참고하세요.</div>
                        </div>
                    <!-- </div> -->
                    ...
                    <div class="row">
                        ...
                        <div class="icon-entry col-sm-4 wow fadeInUp animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                            ...
                            <div class="content">
                                ...
                                <div class="text"><b>사무실:</b> 02-526-3069 <br> <b>Mobile:</b> 010-9915-1341 <br> <b>Fax:</b> 02- 526-3081</div>
                            </div>
                        </div>
                        <div class="icon-entry col-sm-4 wow fadeInRight animated" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInRight;">
                            ...
                            <div class="content">
                                ...
                                <div class="text"><b>회사메일:</b> leebokeum@ildong.com <br> <b>Gmail:</b> leebokeum87@gmail.com <br> <b>Hanmail:</b> leebokeum@hanmail.net</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="block">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-1 wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
