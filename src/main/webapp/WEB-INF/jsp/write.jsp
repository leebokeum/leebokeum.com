...
<div id="content-wrapper">
    ...
    <div class="blocks-container">
        <div class="container blog-wrapper wirte">
            <div class="row">
                <div class="blog-entry write-form wow fadeInLeft animated "
                    ...
                    <form action="${actionUrl }" method="post" enctype="multipart/form-data">
                        <c:choose>
                            <c:when test="${content ne null }">
                                <div class="field-columns write-columns">
                                    <div class="column">
                                        <div class="checkbox-entry checkbox">
                                            <input type="checkbox" name="noticeFlag" value="${content.noticeFlag }">
                                            <label>공지사항</label>
                                        </div>
                                    </div>
                                    <div class="column">
                                        <div class="checkbox-entry checkbox">
                                            <input type="checkbox" name="secretFlag" value="${content.secretFlag }">
                                            <label>나만보기</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="field-entry">
                                    <label for="field-1">제목 *</label> <input type="hidden" name="id"
                                                                             value="${content.id }"> <input type="text"
                                                                                                            required="required"
                                                                                                            name="title"
                                ...
                                <div class="field-entry">
                                    <label for="field-2">서두 (50글자 이내) *</label> <textarea required="required"
                                                                                          name="subTitle"
                                                                                          placeholder="서두를 입력하세요(50글자 이내)"
                                                                                          id="field-2">${content.subTitle }</textarea>
                                </div>
                                <div class="field-entry">
                                    <label for="field-1">내용 *</label>
                                    <textarea id="editor" name="contents"
                                              placeholder="내용을 입력해주세요">${content.contents}</textarea>
                                </div>
                                <div class="field-entry">
                                    <label for="tags">태그 *</label> <input type="text" required="required" name="tag"
                                                                          placeholder="태그를 입력하세요(쉼표로 구분 해서 넣기)"
                                                                          id="tags" value="${content.tag }">
                                </div>
                                <div class="field-entry">
                                    <label for="field-1">작성자 *</label> <input type="text" name="createrName"
                                                                              placeholder="작성자 이름"
                                                                              value="${content.createrName }"
                                                                              required="required">
                                </div>
                                <div class="field-columns write-columns">
                                    <div class="column">
                                        ...
                                        <div class="field-entry">
                                            ...
                                            <div class="block-form-wrapper">
                                                <div class="block-form submit">
                                                    <input type="submit" form="addCategoryForm" value="추가"> <input
                                                        type="text" name="categoryName" id="addMenu" form="addCategoryForm"
                            ...
                            <c:otherwise>
                                ...
                                <div class="field-entry">
                                    <label for="field-1">제목 *</label> <input type="text" required="required"
                                ...
                                <div class="field-entry">
                                    <label for="createrName">작성자 *</label> <input type="text" name="createrName"
                                                                                  value="${sessionUser.userName }"
                                                                                  placeholder="작성자 이름"
                                                                                  required="required" id="createrName">
                                </div>
                                <div class="field-columns write-columns">
                                    <div class="column">
                                        <div class="field-entry">
                                    ...
                                    <div class="column">
                                        <div class="field-entry">
                                            ...
                                            <div class="block-form-wrapper">
                                                <div class="block-form submit">
                                                    <input type="submit" form="addCategoryForm" value="추가"> <input
                                                        type="text" name="categoryName" id="addCategory"
