...
<head>
    ...
    <link rel="stylesheet" href="/flipbook/css/wow_book.css" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="/flipbook/css/preview.css"><!-- Uncomment if you are specifically targeting less enabled mobile browsers
	<link rel="stylesheet" media="handheld" href="css/handheld.css?v=2">  -->

    <link href='//fonts.googleapis.com/css?family=News+Cycle' rel='stylesheet' type='text/css'>
    <!-- All JavaScript at the bottom, except for Modernizr which enables HTML5 elements & feature detects -->
    <script src="/flipbook/js/modernizr-1.6.min.js"></script>
...
<div id="container">
    ...
    <div id="main">
        ...
        <div id='features'>
            ...
            <c:forEach begin='1' end='${imgCount}' step='1' varStatus="status">
                <div style="padding: 0px">
                    <img src='/flipbook/portfolio/Portfolio_2nd_2_${status.count+1}.jpg' width="100%" height="100%"/>
                </div>
            </c:forEach>

            <div class='last_cover'>
                <img src="/flipbook/portfolio/lastcover.jpg" width="100%" height="100%"/>
            </div>
        </div> <!-- features -->
...
<script type="text/javascript" src="/flipbook/wow_book.min.js"></script>
...
<!--[if lt IE 7 ]>
<script src="/flipbook/js/dd_belatedpng.js"></script>
