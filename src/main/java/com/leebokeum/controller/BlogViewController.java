...
public class BlogViewController {
    ...
    private String rest(){
        ...
        //ResponseEntity<String> response = new RestTemplate().exchange("https://kauth.kakao.com/oauth/authorize?client_id=REMOVED-KAKAO-KEY&redirect_uri=https://leebokeum.com/oauth&response_type=code", HttpMethod.GET, new HttpEntity(header), String.class);
        ResponseEntity<String> response = new RestTemplate().exchange("https://kauth.kakao.com/oauth/authorize?client_id=REMOVED-KAKAO-KEY&redirect_uri=/oauth&response_type=code", HttpMethod.GET, new HttpEntity(header), String.class);
    ...
    void oauth() {
       ...
       /* HttpHeaders header = new HttpHeaders();
        header.add(HttpHeaders.ACCEPT, MediaType.TEXT_HTML_VALUE);
        header.add("Authorization","Bearer REMOVED-KAKAO-KEY" );
